...
def msg2img(message, bot, text_override=None):
  ...
  if message.mention_everyone: is_pinged = True
                  ...
                  for i in token:
                      ...
                      if in_word_width < max_width:
                          ...
                          if not saved_width_of_line:
                              saved_width_of_line = in_word_width - font.getsize(i)[0] + 7
                          in_word_width = 0
                          width_of_line = 0
                          part_moved = ""
                  line = part_moved
  ...
  for ping in pings:
      pencil.rounded_rectangle((ping[0] + 122, ping[1] + 57, ping[2] + 115, ping[3] + 57), fill = ImageColor.getrgb("#414675"), radius = 7)
  ...
  if is_bot:
      ...
      pencil.text((131+font.getsize(nick)[0]+42, 10+6), 'BOT', font = font, fill = (255,255,255))
      move = font.getsize('BOT')[0]+55
  pencil.text((122, 55), text.strip(), font=font2, fill=(255, 255, 255)) # draw message text
  ...
  pencil.text((13 + 122 + font.getsize(nick)[0]+move, 17), f"Today at {twelvehour} {suffix}",  font = font3, fill = ImageColor.getrgb("#A3A4AA")) # draw time
