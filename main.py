...
vote_button_texts = [
    ...
    "Look at who hasn't voted",
    "Voting only takes 30s :3",
    "uwu i mean vote",
    "hihi vote pls",
    "if you vote you'll get gold",
    "vote=false. go change it",
    "Why haven't you voted yet :(",
    "Stay hydrated! and vote too",
    "hello guys i am the vote button",
    "btw, voting is free",
    "whats that smell? oh you didnt vote",
    "Dogs don't want you to vote",
    "Cats are cute, voting is too",
    "sorry i ate your cake. btw vote",
    "The vote is not a lie",
    "I've voted. What about you?",
    "We made these so you'd vote",
]
...
hints = [
    ...
    "Cat Bot is developed by a single person!",
    "/nuke can be undone! join our support server and make a post.",
    "You could learn a thing or two by looking at our ToS",
    "/last also shows how long the current rain will last!",
    "main.py has over 10000 lines...",
    "A lot of Cat Bot features can be used as minigames!",
    "You can look at the code, but please don't touch it",
]
...
funny = [
    ...
    "get off me",
    "ow stop it hurts",
    "do you know how long it takes to write these?",
    "do you have nothing better to do?",
    "i will bite you",
    "whAT DO YOU WANT",
    "you're wasting your time",
    "want something?",
    "fine. go check the code",
    ...
    "your time has come",
    "why. genuenlingy why (my tongue got stuck sorry)",
    "i think we lost the plot",
    "go say cat or something",
    ...
    "meow",
    "hello i am markiplier in todays video we'll be frying whoever is doing this",
]
