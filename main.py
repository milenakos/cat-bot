...
vote_button_texts = [
    ...
    "voting would make me really happy",
...
funny = [
    ...
    "leave pls",
    "double it",
    "yeah buddy i dont think i will",
    "reconsider",
    "no please ow it hurts",
    "hi ther- oh its you again.",
    "go do something else",
    "*stares intensly*",
    "nope you didnt try hard enough",
    "pong- oh wait wrong command",
    "congrats! you have won...",
    "...absolutely nothing",
    "get out please",
    "i have places to be",
    "uh oh! cat bot isnt responding! womp womp",
    "meow",
    "WHAT DO YOU WANT",
    "wrong button sorry",
    "*nice words*",
    "ok your getting annoying",
    "fun fact: your mom",
    "hmm i wonder what happens when you roll a 0 sided die",
    "what file is this where am i",
    "why are you here again",
    "im suing you",
    "https://minkos.lol/ip",
    "i hope im writing this right",
    "hey no you cant stop",
    "you shouldnt, you really shouldnt",
    "oh for fu-",
    "pls get out",
    "i dont like you at all",
    "hey you know you can run commands yourself right",
    "sorry what",
    "oh you like pie?",
    "AND THE WINNER IS... not you sorry",
    "hol on for a minute i need to eat",
